  ...
  const CORE_MINUS_APPROVE = TOOL_NAMES.filter(
    (n) =>
      ...
      ![
        ...
        "aart_remote_runs",
        "aart_remote_run",
        // Wave 2C (AMENDMENTS.md A64) — extended, gated on trust mode AND
...
// Wave 2C (AMENDMENTS.md A64) — aart_remote_approve is the FIRST tool in
...
describe("aart_remote_approve — TWO independent preconditions: trust mode AND >=1 configured remote (AMENDMENTS.md A64, Wave 2C)", () => {
