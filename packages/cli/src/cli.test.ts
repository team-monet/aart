...
// Wave 2C (AMENDMENTS.md A64) — aart approve-remote, the WRITE-against-
...
describe("aart approve-remote — the REMOTE counterpart of aart approve (Wave 2C, AMENDMENTS.md A64)", () => {
  let remoteHandle: ServerHandle | undefined;
  afterEach(async () => {
    await remoteHandle?.close();
    remoteHandle = undefined;
